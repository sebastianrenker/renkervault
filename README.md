...
- **Windows-Desktop-App** über [Tauri](https://tauri.app) (`client/src-tauri/`)
  ...
  Angriffsvektor als bei Electron. Bauen: `cd client && npx tauri build`.
- **Windows-Installer** über Inno Setup (`installer/RenkerVault.iss`) — bündelt
  die Tauri-App plus optional den Relay-Server zum Selbstbetrieb, mit
  Start-Menü-/Desktop-Verknüpfung. Bauen: `ISCC.exe installer/RenkerVault.iss`.
